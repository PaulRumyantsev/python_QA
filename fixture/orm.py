...
class ORMFixture:
    ...
    class ORMGroup(db.Entity):
        ...
        contacts = Set(lambda: ORMFixture.ORMContacts, table="address_in_groups", column="id", reverse="groups",
                       lazy=True)
    ...
    def get_contacts_not_in_group(self, group):
        ...
        return self.convert_contacts_to_model(
            select(c for c in ORMFixture.ORMContacts if c.deprecated is None and orm_group not in c.groups))
